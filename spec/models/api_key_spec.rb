...
# Unit tests for ElasticEmail::ApiKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ElasticEmail::ApiKey do
  let(:instance) { ElasticEmail::ApiKey.new }

  describe 'test an instance of ApiKey' do
    it 'should create an instance of ApiKey' do
      expect(instance).to be_instance_of(ElasticEmail::ApiKey)
    end
  end
