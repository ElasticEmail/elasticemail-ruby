...
# Unit tests for ElasticEmail::WebhookUpdatePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ElasticEmail::WebhookUpdatePayload do
  let(:instance) { ElasticEmail::WebhookUpdatePayload.new }

  describe 'test an instance of WebhookUpdatePayload' do
    it 'should create an instance of WebhookUpdatePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ElasticEmail::WebhookUpdatePayload)
    end
  end
