...
```shell
gem install ./ElasticEmail-4.0.0.gem
```

(for development, run `gem install --dev ./ElasticEmail-4.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ElasticEmail', '~> 4.0.0'
