  ...
  class Suppression
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::Suppression` initialize method"
      end
    ...
    def hash
      [email, friendly_error_message, error_code, date_updated].hash
    end
