...
module ElasticEmail
  ...
  class VerificationFileResultDetails
    ...
    def self.openapi_types
      {
        :'verification_result' => :'Array<EmailValidationResult>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::VerificationFileResultDetails` initialize method"
      end
      ...
      if attributes.key?(:'verification_result')
        if (value = attributes[:'verification_result']).is_a?(Array)
    ...
    def hash
      [verification_result, verification_id, filename, verification_status, file_upload_result, date_added, source].hash
    end
