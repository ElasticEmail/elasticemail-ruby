  ...
  class Template
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::Template` initialize method"
      end
    ...
    def hash
      [template_type, name, date_added, subject, body, template_scope].hash
    end
