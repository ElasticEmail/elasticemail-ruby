  ...
  class EmailTransactionalMessageData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::EmailTransactionalMessageData` initialize method"
      end
    ...
    def hash
      [recipients, content, options].hash
    end
