  ...
  class SmtpCredentialsPayload
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::SmtpCredentialsPayload` initialize method"
      end
    ...
    def hash
      [name, expires, restrict_access_to_ip_range, subaccount].hash
    end
