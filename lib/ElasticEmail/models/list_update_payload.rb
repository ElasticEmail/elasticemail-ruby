...
module ElasticEmail
  class ListUpdatePayload
    ...
    attr_accessor :new_list_name

    # True: Allow unsubscribing from this list. Otherwise, false
    attr_accessor :allow_unsubscribe
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::ListUpdatePayload` initialize method"
      end
      ...
      if attributes.key?(:'new_list_name')
        self.new_list_name = attributes[:'new_list_name']
      end
    ...
    def hash
      [new_list_name, allow_unsubscribe].hash
    end
