...
module ElasticEmail
  class ExportLink
    ...
    attr_accessor :public_export_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::ExportLink` initialize method"
      end
      ...
      if attributes.key?(:'public_export_id')
        self.public_export_id = attributes[:'public_export_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          link == o.link &&
          public_export_id == o.public_export_id
    end
