...
module ElasticEmail
  class InboundRoute
    ...
    attr_accessor :action_parameter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::InboundRoute` initialize method"
      end
      ...
      if attributes.key?(:'action_parameter')
        self.action_parameter = attributes[:'action_parameter']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          action_parameter == o.action_parameter &&
    ...
    def hash
      [public_id, name, filter_type, filter, action_type, action_parameter, sort_order].hash
    end
