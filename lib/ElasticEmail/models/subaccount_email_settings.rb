...
module ElasticEmail
  ...
  class SubaccountEmailSettings
    ...
    attr_accessor :monthly_refill_credits

    # True, if Account needs credits to send emails. Otherwise, false
    attr_accessor :requires_email_credits

    # Maximum size of email including attachments in MB's
    attr_accessor :email_size_limit

    # Amount of emails Account can send daily
    attr_accessor :daily_send_limit
    ...
    attr_accessor :enable_private_ip_purchase
    ...
    def self.openapi_types
      {
        :'monthly_refill_credits' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::SubaccountEmailSettings` initialize method"
      end
      ...
      if attributes.key?(:'monthly_refill_credits')
        self.monthly_refill_credits = attributes[:'monthly_refill_credits']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          monthly_refill_credits == o.monthly_refill_credits &&
