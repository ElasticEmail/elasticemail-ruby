  ...
  class SplitOptions
    ...
    def self.openapi_types
      {
        ...
        :'optimize_period_minutes' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::SplitOptions` initialize method"
      end
      ...
      if attributes.key?(:'optimize_period_minutes')
        self.optimize_period_minutes = attributes[:'optimize_period_minutes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          optimize_for == o.optimize_for &&
          optimize_period_minutes == o.optimize_period_minutes
    end
    ...
    def hash
      [optimize_for, optimize_period_minutes].hash
    end
