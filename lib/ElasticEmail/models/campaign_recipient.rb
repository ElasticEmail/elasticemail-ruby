  ...
  class CampaignRecipient
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::CampaignRecipient` initialize method"
      end
      ...
      if attributes.key?(:'list_names')
        if (value = attributes[:'list_names']).is_a?(Array)
          self.list_names = value
        end
      end

      if attributes.key?(:'segment_names')
        if (value = attributes[:'segment_names']).is_a?(Array)
          self.segment_names = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          list_names == o.list_names &&
          segment_names == o.segment_names
    end
