  ...
  class SortOrderItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::SortOrderItem` initialize method"
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          public_inbound_id == o.public_inbound_id &&
    ...
    def hash
      [public_inbound_id, sort_order].hash
    end
