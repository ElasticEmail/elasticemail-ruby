  ...
  class SmtpCredentials
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ElasticEmail::SmtpCredentials` initialize method"
      end
    ...
    def hash
      [access_level, name, date_created, last_use, expires, restrict_access_to_ip_range].hash
    end
